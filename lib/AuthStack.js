  ...
  constructor(scope, id, props) {
    ...
    this.auth.attachPermissionsForAuthUsers([
      ...
      new iam.PolicyStatement({
        ...
        resources: [
          // granting logged in users access to the path private/xxx within our S3 bucket's ARN.
          // where cognito-identity.amazonaws.com:sub is the authenticated user's userId
